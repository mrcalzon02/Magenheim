...
- [x] 0.0.103 closeout and installation passed (`41a02be`); see `validation/2026-09-23-monumental-terrain.md`.
- [ ] Follow-up: cap terrain just above the intended cloud/haze line (clarification pending), and
  add the shared lava/fungal-star skybox with dim natural day/night and no visible sun.
