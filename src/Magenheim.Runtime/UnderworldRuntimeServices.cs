...
internal sealed class UnderworldRuntimeServices
{
    ...
    {
        if(!UnderworldRuntimeIdentityResolver.TryResolveLocalSession(SpatialDomain,out identity,out layer,out playerId,out diagnostic)||identity is null)return false;
