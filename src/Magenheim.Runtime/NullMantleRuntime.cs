...
internal sealed class NullMantleRuntime : MonoBehaviour
{
    ...
    private void ApplyPresentation()
    {
        ...
        var crown=ModelAssets.Load(_presentation,"broken-crown",hideOriginal:false);crown.name="BrokenCrown";crown.transform.localPosition=new Vector3(0f,2.05f,0f);crown.transform.localScale=new Vector3(.42f,.10f,.42f);
