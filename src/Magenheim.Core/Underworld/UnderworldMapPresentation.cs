...
/// <summary>
/// Pure presentation policy for the tabbed Surface | Underworld map. Physical host coordinates are
/// deliberately absent from this model: the ~40 km region is simulation/storage space, never
