...
- [ ] **Close the texture gap.** IN PROGRESS: 230/281 models textured (82%), from 111 at `924f5e7`; parts 82% from 36%. Districts, geode, crystal tiers, passages and all 104 creature variants done. 51 remain, led by crystal (13), decor (10) and boss (8). A black-texture gate guards the work.
