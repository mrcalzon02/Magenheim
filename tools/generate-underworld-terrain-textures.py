#!/usr/bin/env python3
"""Generate deterministic custom PBR foundations for the six Underworld terrain biomes.
...
roughness maps with biome-specific surface language.
"""
...
def main():
    ...
    for index, (name, (base, rough_base, normal_gain)) in enumerate(BIOMES.items(), 1):
        ...
        albedo = Image.new("RGB", (SIZE,SIZE)); normal = Image.new("RGB", (SIZE,SIZE)); rough = Image.new("L", (SIZE,SIZE))
        ...
        print(f"generated {name}: 256px albedo/normal/roughness")
