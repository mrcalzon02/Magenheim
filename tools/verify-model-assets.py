...
# 328 = 300 + the twelve elemental Surtlings (tools/author-underworld-surtlings.py)
# + sixteen Fungal Forest flora and resources (tools/author-underworld-fungal-forest.py).
assert len(rows)==328,('Unexpected asset coverage',len(rows))
