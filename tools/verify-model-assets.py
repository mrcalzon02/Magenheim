...
# 344 = 300 + the twelve elemental Surtlings (tools/author-underworld-surtlings.py)
# + sixteen Fungal Forest and sixteen Blackwater flora/resources.
assert len(rows)==344,('Unexpected asset coverage',len(rows))
