...
internal static class DefinitionAuthorityTests
{
    public static int Run()
    {
        ...
        var local = new DefinitionAuthorityDescriptor(2, fingerprintA);
        ...
        var compatible = DefinitionAuthorityHandshake.Compare(local, new DefinitionAuthorityDescriptor(2, fingerprintA));
        ...
        var schemaMismatch = DefinitionAuthorityHandshake.Compare(local, new DefinitionAuthorityDescriptor(3, fingerprintA));
        ...
        var fingerprintMismatch = DefinitionAuthorityHandshake.Compare(local, new DefinitionAuthorityDescriptor(2, fingerprintB));
        ...
        var invalidLocal = DefinitionAuthorityHandshake.Compare(
            ...
            new DefinitionAuthorityDescriptor(2, fingerprintA));
        ...
        var invalidRemote = DefinitionAuthorityHandshake.Compare(
            local,
            new DefinitionAuthorityDescriptor(2, fingerprintA.ToUpperInvariant()));
        ...
        Assert(!DefinitionAuthorityHandshake.IsValid(new DefinitionAuthorityDescriptor(2, "abc"), out _), "Wrong-length fingerprints must be invalid.");
